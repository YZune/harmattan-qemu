...
| `HARMATTAN_UI_CALL_LOCKSCREEN` | `off` (default) / `on`; requires call simulation and lockscreen, see [locked incoming calls](call-simulation.md#locked-incoming-calls) |
