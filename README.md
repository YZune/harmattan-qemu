...
Special thanks to OpenAI's **GPT and Codex** for their sustained collaboration throughout this project: exploring historical source code, porting the emulator, debugging graphics and interaction, developing validation tools, and preparing bilingual documentation and releases. I could not have brought this project this far on my own. Their help made it possible to turn my curiosity about the Nokia N9 into an emulator that runs again and a project I can share with the community.
