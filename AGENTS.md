...
- The normal native launcher clones the guest disk and uses disposable snapshots. Guest edits are lost on exit. Do not substitute the historical persistent x86/Rosetta `run-pr13-ui.sh` launcher.
